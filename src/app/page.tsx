...
export default function Home() {
  ...
  return (
    ...
    <div className="container p-2" style={{ minHeight: "80vh", marginTop: 32 }}>
      <h3 className="text-center"><strong>Sản phẩm nước ngoài</strong></h3>
      <div className="content-separate"></div>
      <div className="d-flex justify-content-center">
        <button className="btn btn-outline-dark filter__btn" onClick={() => handleClassify("All")}>Tất cả</button>
